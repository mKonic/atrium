...
constexpr Palette kDark{
    ...
    .window_background = 0x323232ff, .control_background = 0x1e1e1eff, .control = 0xffffff3f, .thumb = 0xdcdcdcff,
...
constexpr Palette kLight{
    ...
    .window_background = 0xecececff, .control_background = 0xffffffff, .control = 0xffffffff, .thumb = 0xffffffff,
    .accent = 0, .on_accent = 0, .accent_fill = 0, .focus_ring = 0,
